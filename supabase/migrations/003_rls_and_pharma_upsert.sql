...
-- ==========================================================================
DROP POLICY IF EXISTS "anon_read" ON universe_members;
DROP POLICY IF EXISTS "anon_read" ON prices_daily;
DROP POLICY IF EXISTS "anon_read" ON fundamentals_snapshot;
DROP POLICY IF EXISTS "anon_read" ON trend_radar;
DROP POLICY IF EXISTS "anon_read" ON pharma_trials;
DROP POLICY IF EXISTS "anon_read" ON pharma_signals;
DROP POLICY IF EXISTS "anon_read" ON pdufa_calendar;
DROP POLICY IF EXISTS "anon_read" ON sponsor_ticker_map;
DROP POLICY IF EXISTS "anon_read" ON earnings_calendar;
DROP POLICY IF EXISTS "anon_read" ON news_items;
DROP POLICY IF EXISTS "anon_read" ON daily_brief;
DROP POLICY IF EXISTS "anon_read" ON insider_trades_snapshot;
DROP POLICY IF EXISTS "anon_read" ON financial_reports;
...
-- ==========================================================================
DROP POLICY IF EXISTS "service_all" ON universe_members;
DROP POLICY IF EXISTS "service_all" ON prices_daily;
DROP POLICY IF EXISTS "service_all" ON fundamentals_snapshot;
DROP POLICY IF EXISTS "service_all" ON trend_radar;
DROP POLICY IF EXISTS "service_all" ON pharma_trials;
DROP POLICY IF EXISTS "service_all" ON pharma_signals;
DROP POLICY IF EXISTS "service_all" ON pdufa_calendar;
DROP POLICY IF EXISTS "service_all" ON sponsor_ticker_map;
DROP POLICY IF EXISTS "service_all" ON earnings_calendar;
DROP POLICY IF EXISTS "service_all" ON news_items;
DROP POLICY IF EXISTS "service_all" ON daily_brief;
DROP POLICY IF EXISTS "service_all" ON insider_trades_snapshot;
DROP POLICY IF EXISTS "service_all" ON financial_reports;
...
-- ==========================================================================
ALTER TABLE news_items DROP CONSTRAINT IF EXISTS uq_news_items_ticker_url;
...
-- ==========================================================================
ALTER TABLE insider_trades_snapshot DROP CONSTRAINT IF EXISTS uq_insider_symbol_filing_name;
...
-- ==========================================================================
CREATE INDEX IF NOT EXISTS idx_fundamentals_f_score
